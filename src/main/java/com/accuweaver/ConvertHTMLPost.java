...
public class ConvertHTMLPost {
    ...
    final static String DIR_NAME = "/Users/robweaver/Sites/accuweaver.com/httpdocs/wp-content/cache/supercache/blog.accuweaver.com";
    final static String FILE_NAME = DIR_NAME + "/2008/11/19/web-marketing/index.html";
    final static String FILE_NAME2 = DIR_NAME + "/2008/11/21/plaxo-the-service-i-lovehate/index.html";
    final static String OUTPUT_FILE_NAME = "test/data/output/output.xml";
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("hasChildren: " + converter.hasChildren(DIR_NAME));

        List<String> output = new ArrayList<String>();

        output.add("<?xml version=\"1.0\" encoding=\"UTF-8\" ?>");
        output.add("<!-- This is a WordPress eXtended RSS file generated by WordPress as an export of your site. -->\n"
        ...
        converter.addFile(FILE_NAME, output, output);
        converter.addFile(FILE_NAME2, output, output);
